...
```
## Warning in lapply(fish2[, new_numeric], as.numeric): NAs introduced by coercion
```
...
##    country      ISSCAAP_spgroupname   ASFIS_spcode ASFIS_sciname     year  catch
##    <fct>        <fct>                 <fct>        <fct>             <chr> <dbl>
##  1 Un. Sov. So~ Miscellaneous coasta~ 1709201906   Notothenia squam~ 1991   1101
##  2 Un. Sov. So~ Miscellaneous coasta~ 1709201902   Notothenia rossii 1991    287
##  3 Un. Sov. So~ Miscellaneous coasta~ 1709244801   Trematomus eulep~ 1990   1464
##  4 Un. Sov. So~ Miscellaneous coasta~ 1709201906   Notothenia squam~ 1990     24
##  5 Un. Sov. So~ Miscellaneous coasta~ 1709201906   Notothenia squam~ 1990   2399
##  6 Un. Sov. So~ Miscellaneous coasta~ 1709201903   Notothenia gibbe~ 1990    323
##  7 Un. Sov. So~ Miscellaneous coasta~ 1709201902   Notothenia rossii 1990      2
##  8 Un. Sov. So~ Miscellaneous coasta~ 1709201902   Notothenia rossii 1990     19
##  9 Un. Sov. So~ Miscellaneous coasta~ 1709252901   Pagothenia hanso~ 1990      2
## 10 Un. Sov. So~ Miscellaneous coasta~ 1709201910   Notothenia kempi  1990      1

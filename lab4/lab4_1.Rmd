...
2. Why are these data untidy?  
  The variables of income ranges are not in the colums but are the colums' titles. And observations are groupd into single rows by religion
...
2. Why are these data not tidy?  
  The days, which are a vairalbe, are not in columns

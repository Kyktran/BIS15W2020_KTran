...
```
## # A tibble: 5,112 x 5
##    country     continent  year measuredValue observationValue
##    <fct>       <fct>     <int> <chr>                    <dbl>
...
```
## # A tibble: 2 x 4
##   continent minLifeExp maxLifeExp meanLifeExp
##   <fct>          <dbl>      <dbl>       <dbl>
...
##  7 Comoros                710960
##  8 Reunion                798094
##  9 Trinidad and Tobago   1056608
## 10 Swaziland             1133066
## # ... with 132 more rows
```

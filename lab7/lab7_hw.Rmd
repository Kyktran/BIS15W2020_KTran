...
#Notice that year is being treated as a continuous variable.
```{r}
ui <- dashboardPage(
...
#This looks like Davis is the only campus option when you plot the graph (Because you filtered for Davis). 
```{r}
ui <- dashboardPage(

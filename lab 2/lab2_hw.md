...
```r
?msleep ##National Academy of Sciences
```
...
```r
sleepiest <- sleep[sleep[ ,6]  >=  18, ]
sleepiest[,1]
```

```
## [1] "North American Opossum" "Big brown bat"          "Thick-tailed opposum"  
## [4] "Little brown bat"       "Giant armadillo"
```
